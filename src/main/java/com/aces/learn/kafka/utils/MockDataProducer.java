package com.aces.learn.kafka.utils;


import com.aces.learn.kafka.stream.ksia.model.*;
...
import static com.aces.learn.kafka.utils.Topics.*;
...
public class MockDataProducer {
    ...
    private static final String YELLING_APP_TOPIC = "yelling-topic";
    ...
    public static void producePurchaseData(int numberPurchases, int numberIterations, int numberCustomers) {
        Runnable generateTask = () -> {
            ...
            LOG.info("Done generating ksia data");
