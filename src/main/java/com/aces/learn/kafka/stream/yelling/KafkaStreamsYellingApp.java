...
package com.aces.learn.kafka.stream.yelling;
...
public class KafkaStreamsYellingApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KStream<String, String> simpleFirstStream = builder.stream("yelling-topic", Consumed.with(stringSerde, stringSerde));


        KStream<String, String> upperCasedStream = simpleFirstStream.mapValues(String::toUpperCase);

        upperCasedStream.to( "yelling-topic-out", Produced.with(stringSerde, stringSerde));
        ...
        kafkaStreams.start();
        Thread.sleep(60000);
        LOG.info("Shutting down the Yelling APP now 123");
        kafkaStreams.close();
