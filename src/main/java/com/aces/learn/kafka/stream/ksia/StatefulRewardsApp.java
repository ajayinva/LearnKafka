...
public class StatefulRewardsApp {
    ...
    private static Properties getProperties() {
        ...
        props.put(StreamsConfig.CLIENT_ID_CONFIG, "StatefulRewardsApp");
        props.put(ConsumerConfig.GROUP_ID_CONFIG, "StatefulRewardsApp");
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "StatefulRewardsApp");
